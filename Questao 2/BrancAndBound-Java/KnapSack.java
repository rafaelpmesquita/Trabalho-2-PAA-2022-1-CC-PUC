...
public class KnapSack {
    ...
    static int knapSack(int W, Item arr[], int n){
        ...
        //extrai os itens da arvore de decisão, computa o profit de cada filho do item extraido e salva no profitMaximo
        int maxProfit =0;
        while(!Q.isEmpty()){
            //desenfila a lista
            ...
            //v pegando o peso com base na soma do peso do U com o peso do nó presente na posição do level de v.
            v.setWeight(u.getWeight() + arr[v.getLevel()].getWeight());
            //v pegando o lucro com base na soma do lucro do U com o valor do nó presente na posição do level de v.
            v.setProfit(u.getProfit() + arr[v.getLevel()].getValue());

            //maxProfit é atualizado caso o peso acumulado é menor que W e o lucro é maior que o lucro anterior.
            ...
            //se  valor do bound for maior que o MaxProfit, adiciona os valores a um novo array e o adiciona na lista de nós
